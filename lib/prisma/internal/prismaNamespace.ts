...
/**
 * Reference to a field of type 'LaunchMode'
 */
export type EnumLaunchModeFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'LaunchMode'>
